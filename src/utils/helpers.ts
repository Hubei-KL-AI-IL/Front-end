...
export const menuChildren: MenuChildren[] = [
  ...
  { id: crypto.randomUUID(), index: 4, name: '优秀论文', uri: '/info?menu=4&menuchild=0' },
  { id: crypto.randomUUID(), index: 4, name: '知识产权', uri: '/info?menu=4&menuchild=1' },
  { id: crypto.randomUUID(), index: 4, name: '成果奖励', uri: '/info?menu=4&menuchild=2' },

  { id: crypto.randomUUID(), index: 5, name: '人才培养', uri: '/info?menu=5&menuchild=0' },
  { id: crypto.randomUUID(), index: 5, name: '人才引进', uri: '/info?menu=5&menuchild=1' },
  { id: crypto.randomUUID(), index: 5, name: '团队建设', uri: '/info?menu=5&menuchild=2' },

  { id: crypto.randomUUID(), index: 6, name: '新闻中心', uri: '/info?menu=6&menuchild=0' },
  { id: crypto.randomUUID(), index: 6, name: '通知公告', uri: '/info?menu=6&menuchild=1' },
